...
-- 'profesores.id' (BIGINT) cambiado a 'profesores.matricula' (VARCHAR)
-- Tablas relacionadas (grupos, materia_profesores) actualizadas.
-- DATOS: Matrículas de profesor ajustadas a 9 caracteres (ej. p24000001)
-- ===================================================
...
-- Se cambia 'id' por 'matricula' VARCHAR(20) PRIMARY KEY
-- (VARCHAR(20) es correcto para almacenar 9 caracteres)
-- ===================================================
CREATE TABLE profesores (
    matricula VARCHAR(20) PRIMARY KEY, -- CAMBIO: Llave primaria es VARCHAR
...
-- Tabla: paquete_materias (Pivote) (Sin cambios)
...
-- ===================================================
-- Tabla: materia_profesores (Pivote) (MODIFICADA)
-- Se cambia 'profesor_id' a VARCHAR(20) y se actualiza la FK
-- ===================================================
CREATE TABLE materia_profesores (
    id BIGINT UNSIGNED AUTO_INCREMENT PRIMARY KEY,
    profesor_id VARCHAR(20) NOT NULL, -- CAMBIO: Tipo de dato
    materia_id BIGINT UNSIGNED NOT NULL,
    UNIQUE (profesor_id, materia_id),
    CONSTRAINT fk_materia_profesores_profesores FOREIGN KEY (profesor_id) REFERENCES profesores(matricula) ON DELETE CASCADE, -- CAMBIO: Referencia a matricula
    CONSTRAINT fk_materia_profesores_materias FOREIGN KEY (materia_id) REFERENCES materias(id) ON DELETE CASCADE
);

-- ===================================================
-- Tabla: grupos (MODIFICADA)
-- Se cambia 'profesor_id' a VARCHAR(20) y se actualiza la FK
-- ===================================================
CREATE TABLE grupos (
    id BIGINT UNSIGNED AUTO_INCREMENT PRIMARY KEY,
    ...
    CONSTRAINT fk_grupos_profesores FOREIGN KEY (profesor_id) REFERENCES profesores(matricula) -- CAMBIO: Referencia a matricula
);


--  Tabla: alumnos (Sin cambios en DDL)
...
-- Tabla: historiales (Sin cambios en DDL)
CREATE TABLE historiales (
    ...
    CONSTRAINT fk_historiales_grupos FOREIGN KEY (grupo_id) REFERENCES grupos(id)
);


-- Tabla: horarios (NUEVA TABLA) (Sin cambios en DDL)
...
-- ===================================================
-- INSERCIÓN DE DATOS DE PRUEBA (MODIFICADO)
-- ===================================================
USE escuelita;
...
-- ===================================================
-- Tabla: profesores (50 registros) (MODIFICADO)
-- Se inserta 'matricula' de 9 caracteres (ej. 'p24000001')
-- ===================================================
INSERT INTO `profesores` (`matricula`, `nombre`, `apellido_paterno`, `apellido_materno`, `correo`, `telefono`, `area_id`, `created_at`, `updated_at`) VALUES
('p24000001', 'Alberto', 'Gómez', 'Hernández', 'prof1@escuela.edu', '22200001', 1, NOW(), NOW()),
('p24000002', 'Beatriz', 'Pérez', 'López', 'prof2@escuela.edu', '22200002', 4, NOW(), NOW()),
('p24000003', 'Carlos', 'Martínez', 'García', 'prof3@escuela.edu', '22200003', 2, NOW(), NOW()),
('p24000004', 'Diana', 'Ramírez', 'Rodríguez', 'prof4@escuela.edu', '22200004', 3, NOW(), NOW()),
('p24000005', 'Ernesto', 'Sánchez', 'Fernández', 'prof5@escuela.edu', '22200005', 5, NOW(), NOW()),
('p24000006', 'Fátima', 'González', 'Díaz', 'prof6@escuela.edu', '22200006', 1, NOW(), NOW()),
('p24000007', 'Gerardo', 'Cruz', 'Moreno', 'prof7@escuela.edu', '22200007', 2, NOW(), NOW()),
('p24000008', 'Hilda', 'Flores', 'Jiménez', 'prof8@escuela.edu', '22200008', 3, NOW(), NOW()),
('p24000009', 'Ignacio', 'Vázquez', 'Ruiz', 'prof9@escuela.edu', '22200009', 4, NOW(), NOW()),
('p24000010', 'Julieta', 'Mendoza', 'Torres', 'prof10@escuela.edu', '22200010', 5, NOW(), NOW()),
('p24000011', 'Kevin', 'Silva', 'Rojas', 'prof11@escuela.edu', '22200011', 1, NOW(), NOW()),
('p24000012', 'Laura', 'Ortiz', 'Soto', 'prof12@escuela.edu', '22200012', 2, NOW(), NOW()),
('p24000013', 'Mario', 'Guerrero', 'Reyes', 'prof13@escuela.edu', '22200013', 3, NOW(), NOW()),
('p24000014', 'Norma', 'Luna', 'Acosta', 'prof14@escuela.edu', '22200014', 4, NOW(), NOW()),
('p24000015', 'Óscar', 'Castillo', 'Navarro', 'prof15@escuela.edu', '22200015', 5, NOW(), NOW()),
('p24000016', 'Patricia', 'Herrera', 'Salazar', 'prof16@escuela.edu', '22200016', 1, NOW(), NOW()),
('p24000017', 'Quintín', 'Mora', 'Campos', 'prof17@escuela.edu', '22200017', 2, NOW(), NOW()),
('p24000018', 'Raquel', 'Chávez', 'Vega', 'prof18@escuela.edu', '22200018', 3, NOW(), NOW()),
('p24000019', 'Sergio', 'León', 'Medina', 'prof19@escuela.edu', '22200019', 4, NOW(), NOW()),
('p24000020', 'Tania', 'Pineda', 'Guzmán', 'prof20@escuela.edu', '22200020', 5, NOW(), NOW()),
('p24000021', 'Ulises', 'Rangel', 'Cabrera', 'prof21@escuela.edu', '22200021', 1, NOW(), NOW()),
('p24000022', 'Verónica', 'Juárez', 'Osorio', 'prof22@escuela.edu', '22200022', 2, NOW(), NOW()),
('p24000023', 'Walter', 'Domínguez', 'Delgado', 'prof23@escuela.edu', '22200023', 3, NOW(), NOW()),
('p24000024', 'Ximena', 'Ríos', 'Ibarra', 'prof24@escuela.edu', '22200024', 4, NOW(), NOW()),
('p24000025', 'Yael', 'Montes', 'Ponce', 'prof25@escuela.edu', '22200025', 5, NOW(), NOW()),
('p24000026', 'Zoe', 'Solís', 'Padilla', 'prof26@escuela.edu', '22200026', 1, NOW(), NOW()),
('p24000027', 'Adrián', 'Cervantes', 'Lara', 'prof27@escuela.edu', '22200027', 2, NOW(), NOW()),
('p24000028', 'Brenda', 'Figueroa', 'Meza', 'prof28@escuela.edu', '22200028', 3, NOW(), NOW()),
('p24000029', 'César', 'Miranda', 'Álvarez', 'prof29@escuela.edu', '22200029', 4, NOW(), NOW()),
('p24000030', 'Daniela', 'Aguilar', 'Sandoval', 'prof30@escuela.edu', '22200030', 5, NOW(), NOW()),
('p24000031', 'Eduardo', 'Benítez', 'Valencia', 'prof31@escuela.edu', '22200031', 1, NOW(), NOW()),
('p24000032', 'Fernanda', 'Castro', 'Blanco', 'prof32@escuela.edu', '22200032', 2, NOW(), NOW()),
('p24000033', 'Gustavo', 'Rosas', 'Estrella', 'prof33@escuela.edu', '22200033', 3, NOW(), NOW()),
('p24000034', 'Isabel', 'Zavala', 'Márquez', 'prof34@escuela.edu', '22200034', 4, NOW(), NOW()),
('p24000035', 'Javier', 'Paredes', 'Cortés', 'prof35@escuela.edu', '22200035', 5, NOW(), NOW()),
('p24000036', 'Karla', 'Gallardo', 'Ochoa', 'prof36@escuela.edu', '22200036', 1, NOW(), NOW()),
('p24000037', 'Luis', 'Bravo', 'Villalobos', 'prof37@escuela.edu', '22200037', 2, NOW(), NOW()),
('p24000038', 'Mónica', 'Escobar', 'Galindo', 'prof38@escuela.edu', '22200038', 3, NOW(), NOW()),
('p24000039', 'Natalia', 'Fuentes', 'Roldán', 'prof39@escuela.edu', '22200039', 4, NOW(), NOW()),
('p24000040', 'Omar', 'Cano', 'Ortega', 'prof40@escuela.edu', '22200040', 5, NOW(), NOW()),
('p24000041', 'Pedro', 'Vargas', 'Solis', 'prof41@escuela.edu', '22200041', 1, NOW(), NOW()),
('p24000042', 'Queren', 'Valdez', 'Camacho', 'prof42@escuela.edu', '22200042', 2, NOW(), NOW()),
('p24000043', 'Roberto', 'Castañeda', 'Rico', 'prof43@escuela.edu', '22200043', 3, NOW(), NOW()),
('p24000044', 'Sandra', 'Núñez', 'Peña', 'prof44@escuela.edu', '22200044', 4, NOW(), NOW()),
('p24000045', 'Tomás', 'Salas', 'Franco', 'prof45@escuela.edu', '22200045', 5, NOW(), NOW()),
('p24000046', 'Uriel', 'Pacheco', 'Parra', 'prof46@escuela.edu', '22200046', 1, NOW(), NOW()),
('p24000047', 'Violeta', 'Corona', 'Serrano', 'prof47@escuela.edu', '22200047', 2, NOW(), NOW()),
('p24000048', 'William', 'Barrios', 'Romo', 'prof48@escuela.edu', '22200048', 3, NOW(), NOW()),
('p24000049', 'Xochitl', 'Galvan', 'Bautista', 'prof49@escuela.edu', '22200049', 4, NOW(), NOW()),
('p24000050', 'Yadira', 'Escamilla', 'Celis', 'prof50@escuela.edu', '22200050', 5, NOW(), NOW());
...
-- ===================================================
-- Tabla: grupos (50 registros) (MODIFICADO)
-- Se inserta 'profesor_id' como VARCHAR (ej. 'p24000001')
-- ===================================================
INSERT INTO `grupos` (`id`, `nombre`, `materia_id`, `profesor_id`, `created_at`, `updated_at`) VALUES
(1, '101A', 1, 'p24000001', NOW(), NOW()), (2, '101B', 2, 'p24000006', NOW(), NOW()), (3, '201A', 3, 'p24000002', NOW(), NOW()), (4, '301A', 4, 'p24000003', NOW(), NOW()), (5, '401A', 5, 'p24000004', NOW(), NOW()),
(6, '501A', 6, 'p24000005', NOW(), NOW()), (7, '102A', 7, 'p24000011', NOW(), NOW()), (8, '102B', 8, 'p24000016', NOW(), NOW()), (9, '202A', 9, 'p24000009', NOW(), NOW()), (10, '302A', 10, 'p24000008', NOW(), NOW()),
(11, '402A', 11, 'p24000013', NOW(), NOW()), (12, '502A', 12, 'p24000010', NOW(), NOW()), (13, '103A', 13, 'p24000021', NOW(), NOW()), (14, '103B', 14, 'p24000026', NOW(), NOW()), (15, '203A', 15, 'p24000014', NOW(), NOW()),
(16, '303A', 16, 'p24000017', NOW(), NOW()), (17, '403A', 17, 'p24000018', NOW(), NOW()), (18, '503A', 18, 'p24000015', NOW(), NOW()), (19, '104A', 19, 'p24000031', NOW(), NOW()), (20, '104B', 20, 'p24000036', NOW(), NOW()),
(21, '204A', 21, 'p24000019', NOW(), NOW()), (22, '304A', 22, 'p24000023', NOW(), NOW()), (23, '404A', 23, 'p24000028', NOW(), NOW()), (24, '504A', 24, 'p24000020', NOW(), NOW()), (25, '105A', 25, 'p24000041', NOW(), NOW()),
(26, '105B', 26, 'p24000046', NOW(), NOW()), (27, '205A', 27, 'p24000024', NOW(), NOW()), (28, '305A', 28, 'p24000033', NOW(), NOW()), (29, '405A', 29, 'p24000038', NOW(), NOW()), (30, '505A', 30, 'p24000025', NOW(), NOW()),
(31, '106A', 31, 'p24000049', NOW(), NOW()), (32, '106B', 32, 'p24000032', NOW(), NOW()), (33, '206A', 33, 'p24000029', NOW(), NOW()), (34, '306A', 34, 'p24000037', NOW(), NOW()), (35, '406A', 35, 'p24000043', NOW(), NOW()),
(36, '506A', 36, 'p24000030', NOW(), NOW()), (37, '107A', 37, 'p24000048', NOW(), NOW()), (38, '107B', 38, 'p24000027', NOW(), NOW()), (39, '207A', 39, 'p24000034', NOW(), NOW()), (40, '307A', 40, 'p24000042', NOW(), NOW()),
(41, '407A', 41, 'p24000048', NOW(), NOW()), (42, '507A', 42, 'p24000035', NOW(), NOW()), (43, '108A', 43, 'p24000001', NOW(), NOW()), (44, '108B', 44, 'p24000006', NOW(), NOW()), (45, '208A', 45, 'p24000039', NOW(), NOW()),
(46, '308A', 46, 'p24000047', NOW(), NOW()), (47, '408A', 47, 'p24000022', NOW(), NOW()), (48, '508A', 48, 'p24000040', NOW(), NOW()), (49, '109A', 49, 'p24000011', NOW(), NOW()), (50, '109B', 50, 'p24000016', NOW(), NOW());

-- ===================================================
-- Tabla: historiales (50 registros)
-- No se modifica, ya que la FK es a 'grupos(id)'
-- ===================================================
...
(35, 'lunes', '14:00', '16:0E', NOW(), NOW()), (35, 'miercoles', '14:00', '16:00', NOW(), NOW()),
...
-- ===================================================
-- Tabla: materia_profesores (50 registros) (MODIFICADO)
-- Se inserta 'profesor_id' como VARCHAR (ej. 'p24000001')
-- ===================================================
INSERT INTO `materia_profesores` (`profesor_id`, `materia_id`) VALUES
('p24000001', 1), ('p24000006', 2), ('p24000011', 7), ('p24000016', 8), ('p24000021', 13), ('p24000026', 14), ('p24000031', 19), ('p24000036', 20),
('p24000002', 3), ('p24000009', 9), ('p24000014', 15), ('p24000024', 21), ('p24000029', 27), ('p24000034', 33), ('p24000039', 39), ('p24000044', 45),
('p24000003', 4), ('p24000008', 10), ('p24000013', 16), ('p24000018', 22), ('p24000023', 28), ('p24000028', 34), ('p24000033', 40), ('p24000038', 46),
('p24000004', 5), ('p24000013', 11), ('p24000018', 17), ('p24000023', 23), ('p24000028', 29), ('p24000033', 35), ('p24000038', 41), ('p24000043', 47),
('p24000005', 6), ('p24000010', 12), ('p24000015', 18), ('p24000020', 24), ('p24000025', 30), ('p24000030', 36), ('p24000035', 42), ('p24000040', 48),
('p24000041', 25), ('p24000046', 26), ('p24000042', 49), ('p24000047', 50), ('p24000043', 29), ('p24000044', 31), ('p24000045', 32), ('p24000048', 38);
