...
<div class="container">
    ...
    <div class="text-center my-5">
        ...
        <p class="text-muted">Bienvenido de nuevo, {{ Auth::user()->name }}. (Rol: {{ ucfirst(Auth::user()->role) }})</p>
    </div>
    ...
    <div class="dashboard-grid">
        ...
        @if(auth()->user()->role === 'admin')
            ...
            <a href="{{ route('materias.index') }}" class="dashboard-card">
                ...
                <p class="text-muted">Crear y editar las asignaturas.</p>
            </a>
            <a href="{{ route('grupos.index') }}" class="dashboard-card">
                <i class="fas fa-users fa-3x mb-3"></i>
                <h3 class="font-weight-bold">Grupos</h3>
                <p class="text-muted">Organizar a los alumnos en grupos.</p>
            </a>
            ...
            <a href="{{ route('users.index') }}" class="dashboard-card">
                ...
                <p class="text-muted">Gestionar usuarios y contraseñas.</p>
            </a>
            
            <!-- {{-- ============================================= --}}
            {{-- ▼▼▼ TARJETAS AÑADIDAS PARA RELLENAR ESPACIOS ▼▼▼ --}}
            {{-- ============================================= --}}
        ...
        @if(auth()->user()->role === 'profesor')
            <a href="{{ route('grupos.index') }}" class="dashboard-card">
                <i class="fas fa-users fa-3x mb-3"></i>
                <h3 class="font-weight-bold">Mis Grupos</h3>
                <p class="text-muted">Ver los grupos que imparto.</p>
            </a>
        @endif

        {{-- ========= ROL ALUMNO, PROFESOR Y ADMIN ========= --}}
