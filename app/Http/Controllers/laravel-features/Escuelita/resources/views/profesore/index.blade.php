...
<div class="container">
    <div class="row">
        <div class="col-sm-12">
                    ...
                    <form action="{{ route('profesores.index') }}" method="GET" class="row g-3 align-items-center">
                        <div class="col-md">
                            <div class="input-group">
                                ...
                                <input type="text" name="search" class="form-control" placeholder="Buscar por Matrícula, Nombre o Correo..." value="{{ request('search') }}">
                            </div>
                        </div>
            ...
            {{-- ¡AQUÍ! AGREGA ESTE BLOQUE para mensajes de ERROR --}}
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover align-middle">
                            <thead class="table-white">
                                <tr>
                                    {{-- CAMBIO: Mostrar Matrícula en lugar de # --}}
                                    <th>Matrícula</th>
                            ...
                            <tbody>
                                @forelse ($profesores as $profesore)
                                    <tr>
                                        {{-- CAMBIO: Usar $profesore->matricula --}}
                                        <td>{{ $profesore->matricula }}</td>
...
--}}
<td class="text-end">
    <form action="{{ route('profesores.destroy', ['profesore' => $profesore->matricula]) }}" method="POST">
        <a class="btn btn-sm btn-icon btn-info" href="{{ route('profesores.show', ['profesore' => $profesore->matricula]) }}" data-bs-toggle="tooltip" title="Mostrar">
            <i class="fas fa-eye"></i>
        </a>
        <a class="btn btn-sm btn-icon btn-success" href="{{ route('profesores.edit', ['profesore' => $profesore->matricula]) }}" data-bs-toggle="tooltip" title="Editar">
