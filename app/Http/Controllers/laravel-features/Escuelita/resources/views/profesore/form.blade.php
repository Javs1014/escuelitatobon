<div class="row">
    ...
    <div class="col-md-6">
        ...
        {{-- CAMBIO: Moví la matrícula aquí adentro y le di estilo --}}
        <div class="form-floating mb-3">
            <input type="text" name="matricula" class="form-control @error('matricula') is-invalid @enderror" 
                   ...
                   value="{{ old('matricula', $profesore?->matricula) }}" 
                   {{-- Esto hace que sea de solo lectura si el profesor ya existe --}}
                   {{ $profesore?->matricula ? 'readonly' : '' }} required>
            <label for="matricula"><i class="fas fa-id-card me-2"></i>Matrícula</label>
