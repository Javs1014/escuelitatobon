    ...
    <div class="row">
        <div class="col-sm-12">
            ...
            <div class="d-flex justify-content-between align-items-center my-4">
                ...
                {{-- 
                    SOLUCIÓN (CREATE):
                    Solo el Administrador puede ver el botón "Añadir".
                --}}
                        ...
                        <table class="table table-hover align-middle">
                            <thead class="table-white">
                                <tr>
                                    ...
                                    {{-- CAMBIO 1 (Acciones): Ocultar cabecera si es Alumno --}}
                            ...
                            <tbody>
                                @forelse ($historiales as $historiale)
                                    <tr>
                                        ...
                                        {{-- 
                                          CAMBIO 2 (Acciones): 
                                          Mostramos botones según el rol.
                                          Si es 'Alumno', esta celda no se imprime.
                                        --}}
                                        @if(Auth::user()->role !== 'Alumno')
                                            <td class="text-end">
                                                
                                                {{-- 
                                                  El botón de "Ver" (show) lo pueden ver
                                                  tanto Admin como Profesor.
                                                --}}
                                                ...
                                                {{-- 
                                                  El botón de "Editar" (edit) lo pueden ver
                                                  tanto Admin como Profesor ("solo puede modificar").
                                                --}}
                                                @if(Auth::user()->role === 'Administrador' || Auth::user()->role === 'Profesor')
                                                ...
                                                {{-- 
                                                  El botón de "Borrar" (destroy)
                                                  solo lo puede ver el Administrador.
                                                --}}
                                                @if(Auth::user()->role === 'Administrador')
                                                    <form action="{{ route('historiales.destroy', $historiale->id) }}" method="POST" class="d-inline">
                                                        @csrf
                                                        @method('DELETE')
                                ...
                                @empty
                                    <tr>
                                        {{-- CAMBIO 3 (Colspan): Ajustar dinámicamente --}}
                                        <td colspan="{{ Auth::user()->role !== 'Alumno' ? '11' : '10' }}" class="text-center py-5">
